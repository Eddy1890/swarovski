...
function RingSizer() {
    try {
      ...
      function injectStyleDefinitions() {
        ...
        css += ".ab-cc-card {position: absolute; bottom: 0; left: 0; height: 200px; width: 317px; background-image: url('https://media.swarovski.com/pd/Credit_Card.svg'); background-repeat: no-repeat; background-size: 100% 100%; z-index: 10}";
        css += ".ab-cc-template {height: 303px; width: 480px; background-image: url('https://media.swarovski.com/pd/CC_Background.svg'); background-position: top left; background-repeat: no-repeat}";
